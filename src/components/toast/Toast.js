...
const Toast = ({ showtoast }) => {
    return (
        <>
            <div className={`absolute mt-[7rem] md:mt-0 transition-all duration-500 ease-in ${showtoast ? 'translate-x-[-5rem]' : 'translate-x-[30rem]'} right-0 top-5 flex items-center w-[35%] md:w-[14%] h-[2.5rem] rounded-full p-4 mb-4 text-gray-500 bg-white shadow dark:bg-gray-600`} role="alert">
